Vagrant.configure("2") do |config|
  ...
  config.vm.define :centos6 do |centos6|
    ...
    centos6.vm.provision "shell", inline: "curl -L https://www.opscode.com/chef/install.sh | sudo bash"
  end
  ...
  config.vm.define :saucy do |saucy|
    ...
    saucy.vm.provision "shell", inline: "curl -L https://www.opscode.com/chef/install.sh | sudo bash"
  end
